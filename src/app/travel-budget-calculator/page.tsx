...
const faqItems = [
  {
    ...
    answer:
      "Enter your departure city, total budget, trip length, travel style, timing, and priorities. The calculator estimates flights, accommodation, food, local transport, activities, and a buffer.",
  },
  {
...
export const metadata = createMetadata({
  title: "Travel Budget Calculator: Calculate Trip Cost",
  description:
    "Use this travel budget calculator to calculate trip cost with estimates for flights, hotels, food, transport, activities, buffers, trip length, and travel style.",
  path,
  robots: {
    index: true,
    follow: true,
        ...
        <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
              Calculate trip cost with flights, stays, food, local transport, activities, and a safety buffer.
              Use it as a trip budget calculator, travel cost calculator, or vacation calculator before you book.
            </p>
          </div>
          <div className="mt-8">
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
            <div>
              ...
              <p className="mt-4 text-sm leading-6 text-slate-500">
                This travel budget calculator estimates what destinations may fit your budget by combining your
