      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto grid min-h-[720px] max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
          <div className="max-w-xl pt-8">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-650">{t.home.subtitle}</p>
          </div>
      ...
      <section id="destinations" className="bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              <p className="text-sm font-semibold uppercase tracking-wide text-blue-600">{t.home.destinationsEyebrow}</p>
              <h2 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">
                {t.home.destinationsTitle}
              </h2>
            </div>
            <p className="max-w-xl text-sm leading-6 text-slate-500">{t.home.destinationsCopy}</p>
          </div>
      ...
      <section className="bg-slate-50 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm font-semibold uppercase tracking-wide text-teal-700">{t.home.toolsEyebrow}</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">{t.home.toolsTitle}</h2>
          </div>
