...
export const cityDestinations: CityDestination[] = [
  ...
  },
  {
    ...
    tags: ["Harbour", "Beaches", "Premium"],
    description: "A premium long-haul city where beaches and harbour days are excellent, but flights and hotel costs need a larger budget.",
    popularity: 92,
    visaDifficulty: "Check requirements",
  },
  {
