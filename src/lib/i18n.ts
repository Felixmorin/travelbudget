...
export const translations = {
  en: {
    ...
    about: {
      ...
      approachCopyTwo:
        "The product is designed for fast exploration today, with saved trips, richer live pricing, and booking integrations ready to layer in as the planning workflow grows.",
    },
    footer: {
    ...
    tools: {
      ...
      flightWatchDescription: "Mock alerts for routes where airfare drives most of the budget.",
  ...
  fr: {
    ...
    tools: {
      ...
      flightWatchDescription: "Alertes fictives pour les trajets ou le vol pese lourd dans le budget.",
